...
### Итоги
1. Познала основы кубера, стало легче воспринимать его
2. Разобралась с helm, понравилось работать с зависимостями
3. Познакомилась с пайплайнами, все хотела попробовать, пока что сделала через Gitlab Action. В дальнейшем хочу перейти на Tekton
4. В целом как разработчик, сильно разворачивание всяких гитлабов не занималось. Случилась такая интересная история пока делала проект, поставила старую версию Гитлаба, захотела ее повысить потом. И такие свистопляски начались, там есть обязательные версии для поднятия мажорной версии, я наверное дня 4 сидела.
5. Поставила систему на мониторинг, в дальнейшем хочу перейти на Grafana alloy и добавить Grafana tempo.

В целом, очень понравился курс, спасибо за знания!
